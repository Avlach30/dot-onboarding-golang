...
// @Param body-payload body authdto.ExchangeRequest true "payload exchange token"
// @Success 200 {object} pkg.BaseResponse{data=authdto.ExchangeResponse} "success"
...
func (h *AuthHandler) ExchangeToken() httprouter.Handle {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		...
		payloadReq := authdto.ExchangeRequest{}
		...
		dataByte, _ := json.Marshal(pkg.BaseResponse{
			Code:    200,
			Message: "success",
			Data:    authdto.ExchangeResponse{Token: token},
		})
...
// @Produce json
// @Param X-Service-Auth-Token header string true "X-Service-Auth-Token"
// @Param body-payload body authdto.OtpRequest true "payload otp request"
...
// @Produce json
// @Param X-Service-Auth-Token header string true "X-Service-Auth-Token"
// @Param body-payload body authdto.OtpValidateRequest true "payload otp request"
// @Success 200 {object} pkg.BaseResponse{} "success"
// @Failure default {object} pkg.BaseResponse "error"
...
func (h *AuthHandler) OtpValidate() httprouter.Handle {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		...
		payloadReq := authdto.OtpValidateRequest{}
		decoder := json.NewDecoder(r.Body)
		if err := decoder.Decode(&payloadReq); err != nil {
			httperror.SetResponse(w, 400, "body payload required")
			return
		...
		if err := h.authUsecase.OtpValidate(r.Context(), authdto.OtpValidateRequest{
...
// @Produce json
// @Param X-Service-Auth-Token header string true "X-Service-Auth-Token"
// @Param body-payload body authdto.OtpRequest true "payload otp request resend"
// @Success 200 {object} pkg.BaseResponse{} "success"
// @Failure default {object} pkg.BaseResponse "error"
