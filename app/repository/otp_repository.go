...
func NewOtpRepository(db *sql.DB) authdomain.OtpRepository {
...
func (r *OtpRepository) Create(ctx context.Context, payload authdomain.OtpEntity) error {
	query := `
		INSERT INTO 
			otps(
				code, 
...
func (r *OtpRepository) FindByIdentifier(ctx context.Context, identifier string) (res authdomain.OtpEntity, err error) {
	query := `
		SELECT
			code, 
			identifier, 
...
func (r *OtpRepository) UpdateByIdentifier(ctx context.Context, identifier string, payload authdomain.OtpEntity) error {
	query := `
		UPDATE 
			otps
		SET 
...
func (r *OtpRepository) Upsert(ctx context.Context, payload authdomain.OtpEntity) error {
	query := `
